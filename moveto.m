function position = moveto(device, motor, distance)
% Slightly different from RELDISPLACE, this function moves the motor
...
% an error of +/- 0.050.
%
% See Also: RELDISPLACE, FINDPOSITION
%
% By Andrew Fowler 
% last edit: 2 december 2010
